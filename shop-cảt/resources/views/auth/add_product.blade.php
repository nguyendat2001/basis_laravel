            ...
            <center>
                <main style="left:400px;">
                    <div class="container px-5" >
                        ...
                        <form action="<?php route('auth.AddProduct') ?>" method="post" enctype='multipart/form-data' style="width:50%;">
                        @csrf <!-- {{ csrf_field() }} -->
                            ...
                            <div class="form-floating mt-3 mb-3">
                                <input type="text" class="form-control" placeholder="Enter password" name="description">
                            ...
                            <div class="form-floating mt-3 mb-3">
                                <input type="text" class="form-control" placeholder="Enter password" name="quantity">
                                <label for="pwd">Quantity</label>
                            </div>
                            <div class="form-floating mt-3 mb-3">
                                <input type="text" class="form-control" placeholder="Enter password" name="price">
